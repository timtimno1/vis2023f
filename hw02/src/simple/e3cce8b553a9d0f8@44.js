...
Inputs.form({
  mt: Inputs.range([0, 100], {lable: "marginTop", step: 1}),
  mr: Inputs.range([0, 100], {lable: "marginRight", step: 1}),
  mb: Inputs.range([0, 100], {lable: "marginBottom", step: 1}),
  ml: Inputs.range([0, 100], {lable: "marginLeft", step: 1})
})
)}
