...
<h3>從上圖中，我們可以看出：
  <ul>
    <li>工作室、政府機構等，多數位於北部地區</li>
    <li>大多數從業者支持將永續發展納入藝術產業的政策和實踐中</li>
    <li>從業者對於數位藝術展覽能否降低碳排放持有不同看法，這反映了對數位轉型在環境影響方面認知的不確定性。</li>
  </ul>
</h3>`
)}

function _5(__query,FileAttachment,invalidation){return(
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["__query","FileAttachment","invalidation"], _5);
